        ...
        Ok(HouseContext {
            ...
            houses: (0..NUM_HOUSES)
                .map(|index| {
                    ...
                    let cusp_longitude = normalize_longitude(first_house_cusp + index as f64 * DEGREES_PER_SIGN)?;
                    Ok(HouseSeed {
                        house,
                        cusp_longitude,
                    })
...
fn whole_sign_house(reference_longitude: f64, target_longitude: f64) -> Result<HouseNumber, DeriveError> {
